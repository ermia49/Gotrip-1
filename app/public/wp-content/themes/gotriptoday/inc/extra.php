<?php
    ...
    function handle_contact_form() {
        ...
        $recaptcha_secret = '6LfYourSecretKeyHere'; // Replace with your actual reCAPTCHA secret key
        ...
        if (!empty($recaptcha_token)) {
            ...
            if (!is_wp_error($recaptcha_response)) {
                ...
                $recaptcha_result = json_decode($recaptcha_body);
                ...
                if (!$recaptcha_result->success || (isset($recaptcha_result->score) && $recaptcha_result->score < 0.5)) {
                    wp_send_json_error('Security verification failed. Please try again.');
                    return;
                }
            }
        }
